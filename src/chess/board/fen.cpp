...
#pragma region parsing
  ...
  Board::Board(std::string fen)
  {
    ...
    state.setInitialState(halfmove, canWhiteCastleKingside, canBlackCastleKingside, canWhiteCastleQueenside, canBlackCastleQueenside, enPassantAvailable, enPassantFile, fiftyMoveCounter);
  }
